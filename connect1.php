...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["Name"]) && isset($_POST["NativePlace"]) && isset($_POST["MobileNumber"]) && isset($_POST["EmailID"]) && isset($_POST["Address"])) {
        ...
        $sql = "INSERT INTO assurance_candidates (Name, NativePlace, MobileNumber, EmailID, Address, 
                 MODHypothecation, CheckLeaf, Photo, AadharCard, PanCard, 
        ...
        if ($stmt) {
           mysqli_stmt_bind_param($stmt, "ssisssssssssi", $Name, $NativePlace, $MobileNumber, $EmailID, $Address, 
              $MODHypothecation, $CheckLeaf, $Photo, $AadharCard, $PanCard, 
             $BankPassbookXerox, $Security, $PronoteType);

            if (mysqli_stmt_execute($stmt)) {
                echo "Assurance Candidate Form submitted successfully.";
            } else {
